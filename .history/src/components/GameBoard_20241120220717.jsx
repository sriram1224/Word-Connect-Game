  ...
  return (
    <div className=" min-h-screen flex flex-col items-center py-10">
      ...
      <div className=" flex flex-col items-center py-10">
        ...
        {/* Share Button */}
        <div className=" border rounded-lg text-2xl border-orange-200 flex flex-row gap-2 items-center">
          <i
            className="fa-solid fa-share text-4xl rounded-lg bg-orange-300 cursor-pointer"
